...
public class Defensa extends Jugador{
    ...
    public Defensa(String nombre, int edad, String nacio, String pieHabil, int rating, Equipo equipo, int Agarre, int Lanzamiento, int Fisico, int Ritmo, int Entrada, int Vision, int Passing, int Regate, int Disparo) {
